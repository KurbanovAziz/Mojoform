...
public class MediaController {
    ...
    public static class VideoConvertRunnable implements Runnable {
        ...
        private VideoConvertRunnable(String videoPath, String newVideoPath) {
            this.videoPath = videoPath;
            this.newVideoPath = newVideoPath;
        }

        public static void runConversion(final String videoPath, final String newVideoPath) {
            new Thread(new Runnable() {
                @Override
                public void run() {
                    try {
                        VideoConvertRunnable wrapper = new VideoConvertRunnable(videoPath, newVideoPath);
        ...
        @Override
        public void run() {
            MediaController.getInstance().convertVideo(videoPath, newVideoPath);
        }
    }
    ...
    private void startVideoConvertFromQueue(String path, String resPath) {
        VideoConvertRunnable.runConversion(path, resPath);
    }
