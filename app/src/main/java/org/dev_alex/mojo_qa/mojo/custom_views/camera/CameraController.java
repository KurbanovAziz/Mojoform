...
public class CameraController {
    ...
    private void subscribe() {
        ...
        Observable<CameraRxWrapper.CaptureSessionData> previewObservable = captureSessionConfiguredObservable
    ...
    private Observable<CameraRxWrapper.CaptureSessionData> waitForAf(@NonNull CameraRxWrapper.CaptureSessionData captureResultParams) {
        return Observable
    ...
    @NonNull
    private Observable<CameraRxWrapper.CaptureSessionData> waitForAe(@NonNull CameraRxWrapper.CaptureSessionData captureResultParams) {
        return Observable
            .fromCallable(() -> createPreviewBuilder(captureResultParams.session, mSurface))
            .flatMap(
    ...
    @NonNull
    private Observable<CameraRxWrapper.CaptureSessionData> captureStillPicture(@NonNull CameraCaptureSession cameraCaptureSession) {
